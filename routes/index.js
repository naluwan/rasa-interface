...
const jh_company = require('./modules/jh_companyInfo')
const jh_subsidy = require('./modules/jh_subsidy')
const jh_leave = require('./modules/jh_leave')
const {authenticator} = require('../middleware/auth')


router.use('/position', authenticator, jh_position)
router.use('/company', authenticator, jh_company)
router.use('/subsidy', authenticator, jh_subsidy)
router.use('/leave', authenticator, jh_leave)
