...
Method.story = {
    ...
    // 使用者步驟按鈕事件
    userStepEvent: (removeBtn, intentBtn, storySpan, input) => {
    ...
    */
        ...
        resNameInput.value = Method.story.randomBotResName()
